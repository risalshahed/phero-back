  ...
  return (
    <footer className="text-white text-center">
      <div className="flex w-full h-60">
        {/* contact us */}
        <div className="w-1/2 flex flex-col justify-center gap-y-2" style={{backgroundColor: '#1F2937'}}>
        ...
        {/* follow us */}
        <div className="w-1/2 flex flex-col justify-center gap-y-4" style={{backgroundColor: '#111827'}}>
